function [traj,tracks]=track2d_faradaywaves(cc,folderin,folderout,fname,maxdist,lmin,flag_pred,npriormax,porder,flag_conf,cent_idx,nframes)
...
% INPUTS
% folderin  : path to folder containing match files
...
save([folderout filesep 'trajs' cent_idx '_' fname '.mat'],'traj');
save([folderout filesep 'param_trajs' cent_idx '_' fname '.mat'],'maxdist','lmin','flag_pred','npriormax','porder','flag_conf','nframes')
